...
\begin{align}
	...
	\label{eq:rot14}
\end{align}
so like the on-site energy, the interaction term commutes with the rotation operator. We now consider the coherent driving terms beginning with \(\Omega_{\uparrow}\). Using \cref{eq:rot8} we have that,
\begin{equation}
