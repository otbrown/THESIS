...
\begin{equation}
	\dot{\rho} = -i\left[H, \rho\right] + \frac{1}{2}\sum_{j,l=0}^{l=3}\gamma_{l}\left[2W_{j}\rho W_{j+l}^{\dagger} - \{W_{j+l}^{\dagger}W_{j}, \rho\}\right],
	\label{eq:dim3-2}
\end{equation}
...
\begin{align}
	...
	&+ \frac{1}{2}\sum_{j,l=0}^{l=3}\gamma_{l}\left[ W_{j+l}^{*} \otimes 2W_{j} - \mathbb{I} \otimes W_{j+l}^{\dagger}W_{j} - W_{j}^{T}W_{j+l}^{*} \otimes \mathbb{I} \right],
	\label{eq:dim3-4}
\end{align}
...
\begin{longtable}{ccc}
	...
	25 & 1 & \(\frac{\gamma_{3}}{2}\left( 2*W \otimes \mathbb{I} - \mathbb{I} \otimes W^{\dagger} \right)\) \\
	26 & 1 & \(-\frac{\gamma_{3}}{2}W^{\dagger} \otimes \mathbb{I} \)  \\
	\hline
	27 & 1 & \(iH_{W}^{T} \otimes \mathbb{I} - \mathbb{I} \otimes iH_{W}\) \\ 
	...
	27 & 16 & \(\frac{\gamma_{3}}{2}\left( 2*W \otimes \mathbb{I} - \mathbb{I} \otimes W^{\dagger} \right)\) \\
